          ...
          <div className="relative rounded-3xl bg-gradient-to-br from-orange-500 via-red-600 to-rose-700 p-8 md:p-12 lg:p-16 overflow-hidden">
            ...
            <div className="relative grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-2xl">
                <h3 className="text-xl font-bold text-slate-900 mb-6">Start Your Java Project</h3>
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="migration">Legacy Migration</option>
                  ...
                  <button 
                    type="submit"
                    className="w-full py-4 px-6 text-base font-semibold text-white bg-gradient-to-r from-orange-500 to-red-600 rounded-lg hover:from-orange-600 hover:to-red-700 transition-all shadow-lg shadow-orange-500/25 flex items-center justify-center gap-2 group"
                  >
