...
const FEATURES = [
  {
    en: {
      ...
      description:
        'Clients book an intake or follow-up without calling during treatment hours. Choose therapist, complaint type and preferred slot — confirmations go to practice and client automatically.'
    },
    nl: {
      title: 'Online afspraak inplannen',
      description:
        'Cliënten boeken een intake of vervolgafspraak zonder te bellen tijdens behandeluren. Kies therapeut, klachtensoort en voorkeurstijd — bevestigingen gaan automatisch naar praktijk én cliënt.'
    }
  },
  {
    en: {
      title: 'Treatments & specialisations',
      description:
        'Clear pages for manual therapy, sports physio, dry needling, rehabilitation and more — so someone with a sports injury does not land on a generic “services” block that could belong to any clinic.'
    },
    nl: {
      title: 'Behandelingen & specialisaties',
      description:
        'Duidelijke pagina’s voor manuele therapie, sportfysio, dry needling, revalidatie en meer — zodat iemand met een sportblessure niet op een generiek “diensten”-blok landt dat bij elke kliniek zou passen.'
    }
  },
  {
    en: {
      title: 'Direct access (DTF) explained',
      description:
        'Explain that clients can start without a GP referral where direct access applies, what screening looks like, and when you still recommend seeing a doctor first — fewer confused calls at reception.'
    },
    nl: {
      title: 'Directe toegang (DTF) uitgelegd',
      description:
        'Leg uit dat cliënten zonder huisartsverwijzing kunnen starten waar directe toegang geldt, hoe screening werkt, en wanneer je toch eerst een arts adviseert — minder verwarrende belletjes aan de balie.'
    }
  },
  {
    en: {
      title: 'Insurance & reimbursement info',
      description:
        'Plain-language pages on supplementary insurance, session coverage and self-pay options. Clients decide whether to book before they ask reception the same three questions every morning.'
    },
    nl: {
      title: 'Vergoeding & verzekering',
      description:
        'Begrijpelijke pagina’s over aanvullende verzekering, vergoeding per zitting en zelf betalen. Cliënten beslissen of ze boeken vóór ze de balie elke ochtend dezelfde drie vragen stellen.'
    }
  },
  {
    en: {
      title: 'Complaints by body area',
      description:
        'Paths for back, neck, shoulder, knee and other common complaints that lead to the right specialisation and booking CTA — matching how people search when they are already in pain.'
    },
    nl: {
      title: 'Klachten per lichaamsdeel',
      description:
        'Paden voor rug, nek, schouder, knie en andere veelvoorkomende klachten die naar de juiste specialisatie en boekings-CTA leiden — zoals mensen zoeken wanneer ze al pijn hebben.'
    }
  },
  {
    en: {
      title: 'Exercises & helpful content',
      description:
        'Space for exercise tips, recovery blogs or video explainers that build trust and support SEO — without turning the site into a random health magazine that forgets the book button.'
    },
    nl: {
      title: 'Oefeningen & nuttige content',
      description:
        'Ruimte voor oefentips, herstelblogs of video-uitleg die vertrouwen en SEO steunen — zonder de site tot een willekeurig gezondheidsblad te maken dat de boekknop vergeet.'
    }
  },
  {
    en: {
      ...
      description:
        'Most “physio near me” searches happen on a phone after training or work. The site loads fast, shows whether you accept new clients and keeps “Book appointment” sticky.'
    },
    nl: {
      title: 'Mobiel afsprakenpad',
      description:
        'De meeste “fysio bij mij”-zoekopdrachten gebeuren op de telefoon na training of werk. De site laadt snel, toont of jullie nieuwe cliënten aannemen en houdt “Maak een afspraak” vast.'
    }
  },
  {
    en: {
      title: 'Client reviews & GP trust',
      description:
        'Highlight client reviews next to booking CTAs, and make it easy for referring GPs or coaches to find your specialisations and contact path.'
    },
    nl: {
      title: 'Cliëntreviews & huisartsvertrouwen',
      description:
        'Toon cliëntreviews naast boekings-CTA’s, en maak het voor verwijzende huisartsen of coaches makkelijk om specialisaties en contactpad te vinden.'
    }
  }
] as const
...
const PROCESS_STEPS = [
  {
    en: {
      ...
      description:
        'We map how new clients find you: GP referral, Google, sports clubs and self-referral via DTF. We note specialisations, caseload and where bookings get stuck between phone and planner.'
    },
    nl: {
      step: '01',
      title: 'Discovery in de praktijk',
      description:
        'We brengen in kaart hoe nieuwe cliënten je vinden: huisartsverwijzing, Google, sportclubs en zelfverwijzing via DTF. We noteren specialisaties, caseload en waar boekingen vastlopen tussen telefoon en planner.'
    }
  },
  {
    en: {
  ...
  },
  {
    en: {
      step: '03',
      title: 'Design for movement & trust',
      description:
        'Visual design that feels active and calm: readable on a phone in the changing room, CTAs that say “Book an appointment”, and space for DTF and insurance answers without clutter.'
    },
    nl: {
      step: '03',
      title: 'Design voor beweging & vertrouwen',
      description:
        'Visueel ontwerp dat actief en rustig oogt: leesbaar op de telefoon in de kleedkamer, CTA’s die “Maak een afspraak” zeggen, en ruimte voor DTF- en verzekeringsantwoorden zonder rommel.'
    }
  },
  {
    en: {
      ...
      description:
        'We build the site, connect the appointment planner you use, publish reimbursement and DTF pages, and train the team to update specialisations or “accepting clients” status without a developer.'
    },
    nl: {
      step: '04',
      title: 'Bouwen, koppelen, trainen',
      description:
        'We bouwen de site, koppelen de afsprakenplanner die jullie gebruiken, publiceren vergoedings- en DTF-pagina’s, en trainen het team om specialisaties of “nieuwe cliënten”-status bij te werken zonder developer.'
    }
  },
  {
    en: {
...
const T = {
  en: {
    ...
    crumbCurrent: 'Website design for physiotherapists',
    badge: 'Physiotherapy practice websites',
    h1: 'Website design for physiotherapists',
    heroSub:
      'A physiotherapy website that turns people in pain into booked intakes — with online scheduling, clear specialisations, direct-access and insurance answers, and a mobile path built for clients, not generic clinic brochures. With 1,500+ completed projects, we know how practices convert online.',
    ...
    problemP3:
      'Google Business Profile and referrals from GPs can create awareness, but your website is where you control the story: which therapist fits which complaint, how direct access works, and how a Maps click becomes a confirmed intake without five emails to reception.',
    ...
    processSub:
      'From the first walkthrough of your intake and specialisations to measuring which pages drive bookings.',
    whyBadge: 'Why Amora Digital',
    whyHead: 'Why physio practices trust us with their digital front desk',
    whySub: 'Practice-aware delivery, local findability support and results you can count in the agenda.',
    whyItems: [
      {
        title: 'Physio practice experience',
        desc: 'We design for DTF, specialisations, sports vs rehab journeys and the questions clients ask about insurance before they book.'
      },
      {
      ...
      },
      {
        ...
        desc: 'We track appointment starts, form completions and call taps so you know the website fills treatment rooms.'
      },
      {
    ...
    costsItems: [
      {
        ...
        desc: 'Homepage, specialisations overview, team, contact, opening hours, location/map and a clear book or call CTA. Ideal for a single location that needs to look trustworthy and state whether new clients are welcome.'
      },
      {
        title: 'Booking-ready practice site',
        desc: 'Everything in Essential, plus integrated online planner, richer specialisation and body-area pages, DTF and reimbursement info, review blocks and analytics on booking clicks. Built for practices that grow through the agenda.'
      },
      {
    ...
    webDesignLinkNote:
      'For projects outside physiotherapy we offer broader website design. Practice builds follow the process on this page.',
    ctaHeading: 'Ready for a website that fills treatment rooms?',
    ctaSub:
      'Tell us about your specialisations, whether you accept new clients and how bookings work today. We will propose a fixed scope for a site clients actually use.',
  ...
  nl: {
    ...
    crumbCurrent: 'Website laten maken voor fysiotherapeuten',
    badge: 'Praktijkwebsites voor fysiotherapie',
    h1: 'Website laten maken voor fysiotherapeuten',
    heroSub:
      'Een fysiotherapiewebsite die mensen met klachten omzet in geboekte intakes — met online plannen, duidelijke specialisaties, antwoorden over directe toegang en vergoeding, en een mobiel pad voor cliënten, geen generieke kliniekbrochure. Met 1.500+ afgeronde projecten weten we hoe praktijken online converteren.',
    ...
    problemP3:
      'Google Bedrijfsprofiel en verwijzingen van huisartsen brengen bekendheid, maar op je website bepaal jij het verhaal: welke therapeut past bij welke klacht, hoe directe toegang werkt, en hoe een Maps-klik een bevestigde intake wordt zonder vijf mails naar de balie.',
    ...
    processSub:
      'Van de eerste doorloop van je intake en specialisaties tot meten welke pagina’s boekingen opleveren.',
    whyBadge: 'Waarom Amora Digital',
    whyHead: 'Waarom fysiopraktijken hun digitale balie aan ons toevertrouwen',
    whySub: 'Praktijkbewuste oplevering, steun voor lokale vindbaarheid en resultaten die je in de agenda telt.',
    whyItems: [
      {
        title: 'Ervaring met fysiopraktijken',
        desc: 'We ontwerpen voor DTF, specialisaties, sport- versus revalidatietrajecten en de verzekeringsvragen die cliënten stellen vóór ze boeken.'
      },
      {
      ...
      },
      {
        ...
        desc: 'We volgen afspraakstarts, formuliercompletions en belacties, zodat je weet dat de website behandelkamers vult.'
      },
      {
    ...
    costsItems: [
      {
        ...
        desc: 'Homepage, specialisatieoverzicht, team, contact, openingstijden, locatie/kaart en een duidelijke boek- of bel-CTA. Ideaal voor één locatie die online betrouwbaar wil ogen en wil aangeven of nieuwe cliënten welkom zijn.'
      },
      {
        title: 'Boekingsklare praktijksite',
        desc: 'Alles uit Essential, plus geïntegreerde online planner, rijkere specialisatie- en lichaamsdeelpagina’s, DTF- en vergoedingsinfo, reviewblokken en analytics op boekingsklikken. Voor praktijken die via de agenda groeien.'
      },
      {
        title: 'Meerdere locaties of specialisatiefocus',
    ...
    webDesignLinkNote:
      'Voor projecten buiten de fysiotherapie bieden we breder webdesign. Praktijkbuilds volgen het proces op deze pagina.',
    ctaHeading: 'Klaar voor een website die behandelkamers vult?',
    ctaSub:
      'Vertel ons over je specialisaties, of jullie nieuwe cliënten aannemen en hoe boekingen nu lopen. We stellen een vaste scope voor een site die cliënten écht gebruiken.',
    ctaButton: 'Vraag een offerte aan'
  }
} as const

export default function FysiotherapeutenWebsiteLatenMaken() {
