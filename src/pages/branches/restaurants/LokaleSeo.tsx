...
const FEATURES = [
  {
    en: {
      ...
      description:
        'Categories, attributes, menu links and a Reserve button tuned for hospitality — so diners searching tonight see kitchen hours, cuisine type and how to book, not a half-empty profile.'
    },
    nl: {
      title: 'Google Bedrijfsprofiel voor restaurants',
      description:
        'Categorieën, attributen, menulinks en een Reserveer-knop afgestemd op horeca — zodat gasten die vanavond zoeken keukentijden, keukentype en hoe ze boeken zien, geen halfleeg profiel.'
    }
  },
  {
    en: {
      title: 'Local keywords that fill tables',
      description:
        'We target “restaurant [city]”, “[cuisine] restaurant near me” and neighbourhood phrases guests actually type — brunch in De Pijp, sushi near Central Station — not generic “best SEO” keywords.'
    },
    nl: {
      title: 'Lokale zoekwoorden die tafels vullen',
      description:
        'We mikken op “restaurant [stad]”, “[keuken] restaurant bij mij” en buurtfrases die gasten echt typen — brunch in De Pijp, sushi bij Centraal — geen generieke “beste SEO”-termen.'
    }
  },
  {
    en: {
      ...
      description:
        'Visibility in the map pack when someone searches for dinner nearby. NAP consistency, pin accuracy and signals that help your venue appear next to competitors on the same street.'
    },
    nl: {
      title: 'Google Maps & local pack',
      description:
        'Zichtbaarheid in de kaartpack wanneer iemand in de buurt diner zoekt. Consistente NAP, juiste pin en signalen die jouw zaak naast concurrenten in dezelfde straat laten verschijnen.'
    }
  },
  {
    en: {
      title: 'Reviews & rating management',
      description:
        'A steady stream of Google reviews matters more for restaurants than almost any other local cue. We set up request flows after service and reply frameworks that protect your star rating.'
    },
    nl: {
      title: 'Reviews & ratingbeheer',
      description:
        'Een gestage stroom Google-reviews telt voor restaurants zwaarder dan bijna elk ander lokaal signaal. We zetten verzoekflows na de service op en antwoordkaders die je sterrenrating beschermen.'
    }
  },
  {
    en: {
      title: 'GBP photos that create appetite',
      description:
        'Fresh dish, interior and plate shots in Google Business Profile — not stock food. Guests choose where to eat from the photo strip before they open your website.'
    },
    nl: {
      title: 'GBP-foto’s die trek geven',
      description:
        'Verse gerecht-, interieur- en platingfoto’s in Google Bedrijfsprofiel — geen stockfood. Gasten kiezen waar ze eten vanuit de fotostrip vóór ze je website openen.'
    }
  },
  {
    en: {
      title: 'Opening hours that match the kitchen',
      description:
        'Lunch, dinner, late kitchen, holidays and temporary closures kept current in Google so guests do not arrive to a dark dining room — a ranking and reputation killer for hospitality.'
    },
    nl: {
      title: 'Openingstijden die kloppen met de keuken',
      description:
        'Lunch, diner, late kitchen, feestdagen en tijdelijke sluitingen actueel in Google, zodat gasten niet voor een donkere zaak staan — funest voor ranking én reputatie in de horeca.'
    }
  },
  {
    en: {
      title: 'Menu listings in local search',
      description:
        'Menu items, popular dishes and cuisine signals surfaced where Google shows food results — so “best pasta nearby” can connect to what you actually serve tonight.'
    },
    nl: {
      title: 'Menuvermeldingen in lokaal zoeken',
      description:
        'Menuitems, populaire gerechten en keukensignalen daar waar Google foodresultaten toont — zodat “beste pasta in de buurt” kan aansluiten op wat je vanavond écht serveert.'
    }
  },
  {
    en: {
      title: 'Citations & local consistency',
      description:
        'Name, address and phone aligned across directories and hospitality listings so Google trusts your location when ranking the map pack for restaurant searches.'
    },
    nl: {
      title: 'Citations & lokale consistentie',
      description:
        'Naam, adres en telefoon gelijk over directories en horecavermeldingen, zodat Google je locatie vertrouwt bij het ranken van de kaartpack voor restaurantzoekopdrachten.'
    }
  }
] as const
...
const PROCESS_STEPS = [
  {
    en: {
      ...
      description:
        'We check how you appear for “restaurant [your city]”, cuisine + near-me queries and the map pack against nearby competitors. We also audit GBP completeness, hours, photos and review velocity.'
    },
    nl: {
      step: '01',
      title: 'Lokale zichtbaarheidsaudit',
      description:
        'We checken hoe je verschijnt op “restaurant [jouw stad]”, keuken + bij-mij-queries en de kaartpack tegen buurtconcurrenten. Ook GBP-volledigheid, tijden, foto’s en reviewtempo.'
    }
  },
  {
    en: {
      ...
      description:
        'We optimise Google Business Profile for hospitality categories, attributes, menu and Reserve actions, then lock a city/neighbourhood keyword set tied to covers you want to win.'
    },
    nl: {
      step: '02',
      title: 'GBP- & zoekwoordfundament',
      description:
        'We optimaliseren Google Bedrijfsprofiel voor horecacategorieën, attributen, menu en Reserveer-acties, en zetten een stad-/wijkzoekwoordenset vast gekoppeld aan de covers die je wilt winnen.'
    }
  },
  {
    en: {
  ...
  },
  {
    en: {
      ...
      description:
        'We launch review-request habits after service, a photo refresh cadence for new dishes, and citation cleanup so directories do not contradict your kitchen hours.'
    },
    nl: {
      step: '04',
      title: 'Reviews, foto’s & citations',
      description:
        'We starten reviewverzoek-gewoontes na de service, een fotoverversingsritme voor nieuwe gerechten, en citation-opschoning zodat directories je keukentijden niet tegenspreken.'
    }
  },
  {
    en: {
...
const SIBLING_SLUGS = ['website-laten-maken', 'social-media', 'google-ads'] as const
...
const T = {
  en: {
    ...
    crumbCurrent: 'Local SEO for restaurants',
    badge: 'Restaurant local SEO',
    h1: 'Local SEO for restaurants',
    heroSub:
      'Get found when hungry guests search Google Maps and “restaurant near me” — with Google Business Profile optimisation, review growth and neighbourhood keywords that fill covers. With 1,500+ completed projects, we know how hospitality wins locally.',
    ...
    whyItems: [
      {
        ...
        desc: 'We optimise for cuisine, city and neighbourhood searches — peak dinner, brunch and late kitchen — not generic “near me” playbooks from other industries.'
      },
      {
        title: 'Maps & GBP expertise',
        desc: 'Google Business Profile, photos, hours and Reserve actions treated as the front door of local discovery for restaurants.'
      },
      {
    ...
    costsItems: [
      {
        ...
        desc: 'GBP overhaul, hours/menu/Reserve setup, citation cleanup, review process and a neighbourhood keyword set. Ideal for one restaurant that needs to appear properly in Maps first.'
      },
      {
        title: 'Growth (competitive area)',
        desc: 'Ongoing monthly optimisation: photo cadence, review replies, local content for cuisine + district terms, competitor monitoring and reporting on profile actions that lead to covers.'
      },
      {
  ...
  nl: {
    ...
    crumbHub: 'Restaurants & cafés',
    crumbCurrent: 'Lokale SEO voor restaurants',
    badge: 'Lokale SEO voor restaurants',
    h1: 'Lokale SEO voor restaurants',
    heroSub:
      'Word gevonden wanneer hongerige gasten Google Maps en “restaurant bij mij in de buurt” openen — met Google Bedrijfsprofiel-optimalisatie, reviewgroei en buurtzoekwoorden die covers vullen. Met 1.500+ afgeronde projecten weten we hoe horeca lokaal wint.',
    ...
    whyItems: [
      {
        ...
        desc: 'We optimaliseren voor keuken-, stads- en wijkzoekopdrachten — piekdiner, brunch en late kitchen — geen generieke “bij mij”-playbooks uit andere branches.'
      },
      {
        title: 'Maps- & GBP-expertise',
        desc: 'Google Bedrijfsprofiel, foto’s, tijden en Reserveer-acties als voordeur van lokale ontdekking voor restaurants.'
      },
      {
    ...
    costsItems: [
      {
        ...
        desc: 'GBP-overhaul, tijden/menu/Reserveer, citation-opschoning, reviewproces en een wijkzoekwoordenset. Ideaal voor één restaurant dat eerst fatsoenlijk in Maps moet staan.'
      },
      {
        title: 'Growth (concurrerende buurt)',
        desc: 'Doorlopende maandelijkse optimalisatie: fotoritme, reviewantwoorden, lokale content voor keuken + wijktermen, concurrentiemonitoring en rapportage op profielacties die tot covers leiden.'
      },
      {
...
export default function RestaurantsLokaleSeo() {
