...
const SPOKES = BRANCH_SPOKES.tandartsen
...
const T = {
  en: {
    ...
    crumbCurrent: 'Dentists',
    badge: 'Dental marketing',
    h1: 'Online marketing for dentists',
    heroSub:
      'We help dental practices attract new patients and fill their agenda through websites, local SEO, Google Ads and social media. With 1,500+ completed projects, we know what works for dental clinics.',
    ...
    whyItems: [
      {
        ...
        desc: 'We know dental practices: patient trust, treatment pages, reviews and the need for a full agenda.'
      },
      {
        title: 'Local focus',
        desc: 'Patients search nearby. We optimise for local visibility and Google Business Profile.'
      },
      {
        title: 'Measurable results',
        desc: 'We steer on new patients, calls and bookings — not vanity metrics alone.'
      },
      {
  ...
  nl: {
    ...
    crumbCurrent: 'Tandartsen',
    badge: 'Tandartsmarketing',
    h1: 'Online marketing voor tandartsen',
    heroSub:
      'Wij helpen tandartspraktijken nieuwe patiënten aantrekken en hun agenda vullen via websites, lokale SEO, Google Ads en social media. Met 1.500+ afgeronde projecten weten we wat werkt voor tandartsen.',
    ...
    whyItems: [
      {
        ...
        desc: 'We kennen tandartspraktijken: patiëntenvertrouwen, behandelpagina’s, reviews en het belang van een volle agenda.'
      },
      {
        title: 'Lokale focus',
        desc: 'Patiënten zoeken dichtbij. Wij optimaliseren voor lokale zichtbaarheid en Google Bedrijfsprofiel.'
      },
      {
        title: 'Meetbare resultaten',
        desc: 'We sturen op nieuwe patiënten, belacties en afspraken — niet alleen vanity metrics.'
      },
      {
...
export default function Tandartsen() {
