            ...
            <div className="relative grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div>
                  ...
                  <textarea id="description" name="description" rows={3} className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Tell us about your project..." />
                </div>
              </LeadForm>
            </div>
          </div>
